...
| scikit-learn | TF-IDF vectorizer and cosine similarity for finding similar movies |
| Flask | The web framework that runs the browser interface |
| HTML/CSS/JS | The visual interface you interact with |
...
```
git clone https://github.com/alexdavidovmain/movie-recommender.git
